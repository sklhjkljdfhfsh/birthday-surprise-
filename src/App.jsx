    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Pita</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Pita's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Every second I missed you so much 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Juna 💖</h2>
          <p className="final-subtitle">Always and forever ✨</p>
        </section>
      </div>
